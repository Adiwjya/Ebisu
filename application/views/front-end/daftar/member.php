                ...
                <div class="signin-content" >
                    <div class="jarak">
                        <div class="social-login">
                            <ul class="socials">
                                <li><a href="#" onclick="pilih('<?php $p1 = 'PKT001'; echo $p1; ?>')"><i class="display-flex-center zmdi zmdi-facebook" style="width: 200px; height:0px; content:none;"><img src="<?php echo base_url(); ?>assets/front-end/images/undraw_laravel_and_vue_59tp.svg" alt="sing up image"></i></a>
                                <h3 style="text-align: center; margin-top:130px;">Pilih Paket <br> <small>$00.00</small> </h3>
                            </li>
                            </ul>
                        </div>
                    </div>
                    <div class="jarak">
                        <div class="social-login">
                            <ul class="socials">
                                <li><a href="#" onclick="pilih('<?php $p2 = 'PKT002'; echo $p2; ?>')"><i class="display-flex-center zmdi zmdi-facebook" style="width: 200px; height:0px; content:none;"><img src="<?php echo base_url(); ?>assets/front-end/images/undraw_visual_data_b1wx.svg" alt="sing up image"></i></a>
                                <h3 style="text-align: center; margin-top:130px;">Pilih Paket<br> <small>$00.00</small></h3>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="jarak">
                        <div class="social-login">
                            <ul class="socials">
                                <li><a href="#" onclick="pilih('<?php $p3 = 'PKT003'; echo $p3; ?>')"><i class="display-flex-center zmdi zmdi-facebook" style="width: 200px; height:0px; content:none;"><img src="<?php echo base_url(); ?>assets/front-end/images/undraw_business_plan_5i9d.svg" alt="sing up image"></i></a>
                                <h3 style="text-align: center; margin-top:130px;">Pilih Paket<br> <small>$00.00</small></h3>
                                </li>
                            </ul>
                        </div>
