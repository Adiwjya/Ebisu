<footer class="ftco-footer ftco-bg-dark ftco-section">
      <div class="container">
      	<div class="row mb-5 pb-5 align-items-center d-flex">
      		<div class="col-md-6">
	            ...
	            <h2 style="font-size: 30px;">Pilih paket pembelajaranmu hari ini!</h2>
	          </div>
      		</div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://themewagon.com/" target="_blank">ThemeWagon</a>
  ...
  <script src="<?php echo base_url(); ?>assets/front-end/js/jquery.easing.1.3.js"></script>
  <script src="<?php echo base_url(); ?>assets/front-end/js/jquery.waypoints.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/front-end/js/jquery.stellar.min.js"></script>
  ...
  <script src="<?php echo base_url(); ?>assets/front-end/js/jquery.animateNumber.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/front-end/js/bootstrap-datepicker.js"></script>
  <script src="<?php echo base_url(); ?>assets/front-end/js/jquery.timepicker.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/front-end/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<?php echo base_url(); ?>assets/front-end/js/google-map.js"></script>
