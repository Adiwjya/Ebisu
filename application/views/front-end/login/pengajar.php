...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="card-body login-card-body">
      <p class="login-box-msg">Masuk sebagai pengajar</p>
      ...
      <div class="social-auth-links text-center mb-3">
        <p>- OR -</p>
        <a href="<?php echo base_url(); ?>home/login" class="btn btn-block btn-primary" style="background:#6927ff; ">
          Sign in sebagai Pelanggan
        </a>
      </div>
      <!-- /.social-auth-links -->
