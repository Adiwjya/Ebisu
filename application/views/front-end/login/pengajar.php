...
<body style=" overflow: hidden;">
        ...
        <section class="signup" style="margin-bottom: unset;">
            <div class="container">
                ...
                <div class="signin-form">
                        <h2 class="form-title">Sign in Pengajar</h2>
                        ...
                        <div class="social-login">
                            ...
                            <ul class="socials">
                                <li><a href="<?php echo base_url(); ?>home/login"><i class="display-flex-center zmdi zmdi-facebook" style="width: 110px; content:none;">Member</i></a></li>
                            </ul>
                        </div>
                    </div>
    ...
    function login() {
      ...
      if (email === '') {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>login/ajax_login_pengajar",
          type: "POST",
          data: $('#form').serialize(),
          dataType: "JSON",
